package br.com.felippefloriani.model.dao;

import java.util.List;

import javax.persistence.EntityManager;
 
import br.com.felippefloriani.exceptions.DAOException;
import br.com.felippefloriani.exceptions.ErrorCode;
import br.com.felippefloriani.model.dao.JPAUtil;
import br.com.felippefloriani.model.domain.Produto;
	...
	//recupera todos os produtos cadastrados
	 public List<Produto> getAll() {
	        ...
	        try {
	        	...
	        	//DAOException 500 - RutimeException = qualquer exceção lançada pelo provedor de persistência
